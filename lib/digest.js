 ...
 function Rsasign(valStr,merchantPrivateKey,algorithm){
 	...
 	try{
		...
		str = RSA.sign(pem,'base64');
 		...
 		console.error('wapllpay SDK Rsasign error : '+e);
 	}	
	return str
}
/**RSA验签
...
function Rsaverify(valStr,sign,yitongPublickKey,algorithm) {
	...
	try{
		...
		flag = verifier.verify(getRSAPublicKey(yitongPublickKey),sign,"base64");
	}catch(e){
		console.error('wapllpay SDK Rsaverify error : '+e);
	}
	return flag;
}
module.exports = {
